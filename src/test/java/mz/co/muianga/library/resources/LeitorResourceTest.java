...
public class LeitorResourceTest {
	...
	void setUp() {
		...
		mockMvc = MockMvcBuilders.standaloneSetup(leitorResources).build();
	}
	...
	void findAllTest() throws Exception {
		...
		mockMvc.perform(get("/leitores").contentType(MediaType.APPLICATION_JSON)).andExpect(status().isOk())
